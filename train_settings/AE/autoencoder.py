...
from dataset.Doosan import Doosan
...
def run(settings):
    ...
    settings.description = 'Siamese AutoEncoder with default settings.'
    ...
    # Train datasets
    DS_train = Doosan(settings.env.DS_dir, split='train')

    # Validation datasets
    DS_val = Doosan(settings.env.DS_dir, split='val')
    ...
    data_processing_train = processing.DSProcessing(search_area_factor=settings.search_area_factor,
    ...
    data_processing_val = processing.DSProcessing(search_area_factor=settings.search_area_factor,
                                                  output_sz=settings.output_sz,
                                                  center_jitter_factor=settings.center_jitter_factor,
                                                  scale_jitter_factor=settings.scale_jitter_factor,
                                                  mode='sequence',
