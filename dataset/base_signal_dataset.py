...
class BaseSignalDataset(torch.utils.data.Dataset):
    """ Base class for image datasets """

    def __init__(self, name, root, signal_loader=mat4py_loader):
        """
        args:
        ...
        self.signal_list = []     # Contains the list of sequences.
        self.class_list = []
    ...
    def get_image(self, signal_id, anno=None):
        """ Get a signal

        args:
            signal_id      - index of signal
